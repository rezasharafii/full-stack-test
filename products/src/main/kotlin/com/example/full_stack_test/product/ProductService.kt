...
class ProductService(
    ...
    fun searchProductsForView(
        title: String?,
        sort: String = "createdAt",
        dir: String = "desc"
    ): List<ProductView> {
        val rows = if (title.isNullOrBlank()) {
            productRepository.findAllWithVariantsSorted(sort, dir)
        } else {
            productRepository.findByTitleWithVariantsSorted(title.trim(), sort, dir)
        }

        return mapToProductViews(rows)
    }

    fun filterProductsForView(
        title: String?,
        productType: String?,
        vendor: String?,
        minPrice: BigDecimal?,
        ...
        val rows = productRepository.findFilteredWithVariants(
            title = title,
    ...
    fun getProductTypesForFilter(): List<String> =
        productRepository.findDistinctProductTypes()
